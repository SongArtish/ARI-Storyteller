...
def validate(model, criterion, valset, iteration, batch_size, collate_fn, epoch, dur, logger):
...
def train(output_directory, checkpoint_path, warm_start, hparams):
    ...
    ####TODO####
    logger = prepare_directories_and_logger(output_directory, "C:\\SSAFY\\tts_log")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output_directory', type=str,
                        help='directory to save checkpoints',default = "C:\\SSAFY\\tts_checkpoints")
    ...
    with open('C:\\Users\\multicampus\\Desktop\\test\\speak_image\\TTS\\config.yaml') as f:
            hparams = yaml.load(f)
