...
class Solver(object):
    ...
    def save_model(self, iteration):
        ...
        torch.save(self.model.state_dict(), f'{self.args.store_model_path}/model_{iteration}.ckpt')
        torch.save(self.opt.state_dict(), f'{self.args.store_model_path}/opt_{iteration}.opt')
    ####TODO####
